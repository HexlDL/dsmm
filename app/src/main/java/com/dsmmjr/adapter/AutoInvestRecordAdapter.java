 ...
 * 　　　　　┗┻┛　┗┻┛
 */
public class AutoInvestRecordAdapter extends BaseLVAdapter<CapitalDetailEntity.DataBean.ListBean> {

    private List<CapitalDetailEntity.DataBean.ListBean> datas;
    private LayoutInflater mInflater;

    public AutoInvestRecordAdapter(Context context) {
        super(context);
    ...
    public View baseGetView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vh = new AutoVH(convertView);
            convertView.setTag(vh);
        } else {
            vh = (AutoVH) convertView.getTag();
        }
