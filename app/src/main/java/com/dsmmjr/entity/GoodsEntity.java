...
public class GoodsEntity {
    ...
    private int code;
    private String msg;
    private PointEntity.DataBean data;
    ...
    public PointEntity.DataBean getData() {
        return data;
    }

    public void setData(PointEntity.DataBean data) {
        this.data = data;
    }

    public static class DataBean {
        private List<PointEntity.DataBean.EntityListBean> entity_list;

        public List<PointEntity.DataBean.EntityListBean> getEntity_list() {
            return entity_list;
        }

        public void setEntity_list(List<PointEntity.DataBean.EntityListBean> entity_list) {
