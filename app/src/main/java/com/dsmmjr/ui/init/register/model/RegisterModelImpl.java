...
public class RegisterModelImpl implements IRegisterModel {
    @Override
    public void getVerifyCode(String phone, final ICallBackListener<RegisterEntity> listener) {
        ...
        OkHttpUtils.postAsyn(DsmmConfig.BASE_HTTP + "/pub/sendcodeforreg", callback, params);
    }
}
