...
public class NoticeModelImpl implements INoticeModel {
    ...
    @Override
    public void loadNotice(int page, int defualtPageCount, final ICallBackListener<NoticeEntity> listener) {
        ...
        OkHttpUtils.ResultCallback<String> callback = new OkHttpUtils.ResultCallback<String>() {
            ...
            public void onResponse(String response) {
                listener.onSuccessed(JsonUtils.deserialize(response, NoticeEntity.class));
            }
        };

        OkHttpUtils.postAsyn(DsmmConfig.BASE_HTTP + "/news/getNotice", callback, params);
