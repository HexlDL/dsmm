 ...
 * 　　　　　┗┻┛　┗┻┛
 */
public class PaymentPwdUpdateModelImpl implements IPaymentPwdUpdateModel {

    @Override
    public void editPinpass(String token, String oldpinpass, String newpinpass,
                            final ICallBackListener<ResponseInfoEntity> listener) {

        Map<String, String> params = new HashMap<>();
        params.put("token", token);
        params.put("oldpinpass", oldpinpass);
        ...
        OkHttpUtils.postAsyn(BASE_HTTP + "/User/editPinpass", callback, params);
