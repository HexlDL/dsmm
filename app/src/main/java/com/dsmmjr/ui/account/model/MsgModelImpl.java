...
public class MsgModelImpl implements IMsgModel {
    @Override
    public void loadMsg(String token, int p, int pagesize, final ICallBackListener<MsgEntity> listener) {
        ...
        OkHttpUtils.ResultCallback<String> callback = new OkHttpUtils.ResultCallback<String>() {
            ...
            public void onResponse(String response) {
                listener.onSuccessed(JsonUtils.deserialize(response, MsgEntity.class));
            }
        };
        OkHttpUtils.postAsyn(BASE_HTTP + "/User/getMsg", callback, params);
    }
}
