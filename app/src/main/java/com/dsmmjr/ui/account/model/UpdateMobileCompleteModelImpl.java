 ...
 * 　　　　　┗┻┛　┗┻┛
 */
public class UpdateMobileCompleteModelImpl implements IUpdateMobileCompleteModel {

    @Override
    public void getModifyPhonesmsCode(String token, String newphone,
        ...
        OkHttpUtils.postAsyn(BASE_HTTP + "/User/getModifyPhonesmsCode", callback, params);
    }
    ...
    public void modifyPhone(String token, String mobile, String code,
        ...
        OkHttpUtils.postAsyn(BASE_HTTP + "/User/modifyPhone", callback, params);
    }
}
